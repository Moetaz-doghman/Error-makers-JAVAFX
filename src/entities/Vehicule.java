...
public class Vehicule {
    ...
    public Vehicule(String matricule, String couleur, String type_vehicule, String marque, String etat_vehicule) {
        this.matricule = matricule;
        this.couleur = couleur;
        this.type_vehicule = type_vehicule;
        this.marque = marque;
    ...
    public Vehicule(int id, String matricule, String couleur, String type_vehicule, String marque, String etat_vehicule) {
        this.id = id;
        this.matricule = matricule;
        this.couleur = couleur;
        this.type_vehicule = type_vehicule;
