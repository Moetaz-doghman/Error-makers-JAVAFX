...
public class AddProduitController implements Initializable {
    ...
    @FXML
    private void ajouterProduit(javafx.event.ActionEvent event) throws SQLException {
        ...
        if (imgG.length() == 0) {
            ...
            sf.ajouterProduit(new Produit(0, prixProduit.getText(), quantiteProduit.getText(), descProduit.getText(), "", nomProduit.getText()));
