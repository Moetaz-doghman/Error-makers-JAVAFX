 ...
 * @author doghm
 */
public class LigneBack1Controller implements Initializable {
 ...
 public void initialize(URL url, ResourceBundle rb) {
       ...
       // CombofiltreSearch.getItems().addAll("Action", "Adventure", "Strategy", "Sports", "Simulation", "ViewAll");
        LoadStat();
        Animations.shake(rootLigne);
        Animations.fadeInUp(rootLigne1);
    ...
    private void gererligne(ActionEvent event)  throws IOException {
         Parent root = javafx.fxml.FXMLLoader.load(getClass().getResource("../GUI/LigneBackCommande.fxml"));
        btnjo.getScene().setRoot(root);
    }
...
//         String foo = txtSearch.getText();
//        
//        int WordTyped = Integer.parseInt(foo);
//          
...
//                if ((p.getId().toLowerCase().toInt().contains(WordTyped.toLowerCase())) 
//                        || (p.getIdcommande().toInt().toLowerCase().contains(WordTyped.toLowerCase())) 
//                        || (p.getIdproduit().toLowerCase().contains(WordTyped.toLowerCase()))
//                        || (p.getQuantite().toLowerCase().contains(WordTyped.toLowerCase()))
//                        
//                        ) {
//                    FiltreLigne.add(p);
//                }
//            }
//           TableViewLigne.setItems(FiltreLigne);
//        }
